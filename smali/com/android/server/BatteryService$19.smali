...
.method public run()V
    ...
    invoke-static {v2}, Lcom/android/server/BatteryService;->access$2500(Lcom/android/server/BatteryService;)Ljava/lang/Object;
    ...
    invoke-static {v2, v4}, Lcom/android/server/BatteryService;->access$4000(Lcom/android/server/BatteryService;Ljava/lang/String;)J
    ...
    invoke-static {v2, v4, v6, v7}, Lcom/android/server/BatteryService;->access$3100(Lcom/android/server/BatteryService;Ljava/lang/String;J)I
    ...
    invoke-static {v4}, Lcom/android/server/BatteryService;->access$2700(Lcom/android/server/BatteryService;)J

    move-result-wide v4

    # setter for: Lcom/android/server/BatteryService;->mSavedBatteryAsoc:J
    invoke-static {v2, v4, v5}, Lcom/android/server/BatteryService;->access$2602(Lcom/android/server/BatteryService;J)J

    .line 1775
    iget-object v2, p0, Lcom/android/server/BatteryService$19;->this$0:Lcom/android/server/BatteryService;

    # getter for: Lcom/android/server/BatteryService;->mSavedBatteryAsoc:J
    invoke-static {v2}, Lcom/android/server/BatteryService;->access$2600(Lcom/android/server/BatteryService;)J
    ...
    invoke-static {v2, v4, v5}, Lcom/android/server/BatteryService;->access$2622(Lcom/android/server/BatteryService;J)J
    ...
    # getter for: Lcom/android/server/BatteryService;->mSavedBatteryAsoc:J
    invoke-static {v5}, Lcom/android/server/BatteryService;->access$2600(Lcom/android/server/BatteryService;)J
    ...
    # += operator for: Lcom/android/server/BatteryService;->mSavedBatteryAsoc:J
    invoke-static {v2, v4, v5}, Lcom/android/server/BatteryService;->access$2614(Lcom/android/server/BatteryService;J)J
